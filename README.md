...
- `public/` — 靜態 Demo 頁面(GitHub Pages 來源)
- `docs/SPEC.md` — 改版規格草案(唯一真相來源,尚未定案)
- `data/chapels.json` — 11 間沖繩教堂結構化資料,抓自官網,含已知資料矛盾標記

## 備註

這是提案/溝通用素材,不是客戶正式網站的程式碼。正式改版會落地在客戶既有的 WordPress(Elementor + ACF + WPML),詳見 `docs/SPEC.md`。
